...
# Generated: Tue Mar  3 19:08:32 IST 2026  (each bug run 3x, best result used)

Project      Issue    Bug Type                               Result     Findings
-------      -----    --------                               ------     --------
cockroach    10214    Resource Deadlock:AB-BA deadlock       DETECTED   leaks=2 dl=0 lb=0
cockroach    1055     Mixed Deadlock:Channel & WaitGroup     DETECTED   leaks=2 dl=1 lb=1
cockroach    10790    Communication Deadlock:Channel & Context DETECTED   leaks=3 dl=0 lb=0
...
cockroach    18101    Resource Deadlock:Double Locking       DETECTED   leaks=1 dl=0 lb=0
cockroach    2448     Communication Deadlock:Channel         DETECTED   leaks=1 dl=0 lb=0
...
cockroach    584      Resource Deadlock:Double Locking       DETECTED   leaks=3 dl=0 lb=0
cockroach    6181     Resource Deadlock:RWR Deadlock         DETECTED   leaks=3 dl=0 lb=0
cockroach    7504     Resource Deadlock:AB-BA Deadlock       DETECTED   leaks=1 dl=0 lb=0
cockroach    9935     Resource Deadlock:Double Locking       DETECTED   leaks=1 dl=0 lb=0
etcd         10492    Resource Deadlock:Double locking       DETECTED   leaks=1 dl=1 lb=1
etcd         5509     Resource Deadlock:Double locking       DETECTED   leaks=1 dl=0 lb=0
etcd         6708     Resource Deadlock:Double locking       DETECTED   leaks=0 dl=1 lb=1
etcd         6857     Communication Deadlock:Channel         DETECTED   leaks=2 dl=0 lb=0
etcd         6873     Mixed Deadlock:Channel & Lock          DETECTED   leaks=3 dl=0 lb=0
etcd         7443     Mixed Deadlock:Channel & Lock          DETECTED   leaks=2 dl=0 lb=0
etcd         7492     Mixed Deadlock:Channel & Lock          DETECTED   leaks=1 dl=2 lb=2
...
grpc         1353     Mixed Deadlock:Channel & Lock          DETECTED   leaks=3 dl=0 lb=0
...
grpc         3017     Resource Deadlock:Double locking       DETECTED   leaks=2 dl=1 lb=1
grpc         660      Communication Deadlock:Channel         DETECTED   leaks=2 dl=0 lb=0
grpc         795      Resource Deadlock:Double locking       DETECTED   leaks=1 dl=1 lb=2
grpc         862      Communication Deadlock:Channel & Context DETECTED   leaks=1 dl=0 lb=0
...
kubernetes   10182    Mixed Deadlock:Channel & Lock          DETECTED   leaks=4 dl=0 lb=0
kubernetes   11298    Communication Deadlock:Channel & Condition Variable DETECTED   leaks=1 dl=0 lb=0
kubernetes   13135    Resource Deadlock:AB-BA deadlock       DETECTED   leaks=4 dl=0 lb=0
kubernetes   1321     Mixed Deadlock:Channel & Lock          DETECTED   leaks=1 dl=0 lb=0
kubernetes   25331    Communication Deadlock:Channel & Context DETECTED   leaks=1 dl=0 lb=0
...
kubernetes   5316     Communication Deadlock:Channel         DETECTED   leaks=1 dl=0 lb=0
...
kubernetes   6632     Mixed Deadlock:Channel & Lock          DETECTED   leaks=4 dl=0 lb=0
kubernetes   70277    Communication Deadlock:Channel         DETECTED   leaks=1 dl=0 lb=0
moby         17176    Resource Deadlock:Double locking       DETECTED   leaks=1 dl=0 lb=0
moby         21233    Communication Deadlock:Channel         DETECTED   leaks=1 dl=0 lb=0
moby         25384    Mixed Deadlock:Misuse WaitGroup        DETECTED   leaks=1 dl=0 lb=0
moby         27782    Communication Deadlock:Channel & Condition Variable DETECTED   leaks=1 dl=0 lb=0
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SCORE: ThreadGraph detected 66 / 68 bugs (97%)
  Detected: 66
  Missed:   2
  Errors:   0
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
